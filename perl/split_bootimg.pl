...
#                   with mkbootimg. 
#
#                   Modified to account for newer boot images
#                   that have no ramdisk
#
######################################################################
...
# The kernel is always there but check anyway
unless ($KERNEL_SIZE == 0) {
print "Writing $k_file ...";
&dump_file($IMAGE_FN, $k_file, $k_offset, $KERNEL_SIZE);
print " complete.\n";
}

# The ramdisk is optional nowadays
unless ($RAMDISK_SIZE == 0) {
